...
def riwayatGadget(gadget_return_history, gadget_borrow_history, gadget, user, value_pos):                              #   F12
...
def riwayatConsumable(consumable_history, consumable, user,value_pos):                              #   F13
